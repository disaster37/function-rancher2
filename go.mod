module github.com/disaster37/function-rancher2
...
replace (
	...
	github.com/hashicorp/terraform-exec => github.com/hashicorp/terraform-exec v0.13.3
...
require (
	...
	github.com/crossplane-contrib/function-go-templating v0.11.4
	github.com/crossplane/crossplane-runtime/v2 v2.2.0
	github.com/crossplane/function-sdk-go v0.6.0
	github.com/disaster37/provider-rancher2 v0.0.0-20260311134333-5e238ce6e0b6
